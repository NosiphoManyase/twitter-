    ...
    <div>
        {open && (
            <Modal 
                ...
                className='max-w-lg w-[90%] absolute top-24 left-[50%] translate-x-[-50%] bg-white border-gray-400 rounded-xl shadow-md focus:ring-0'
            >
                <div className="p-1">
                    <div className="border-b border-gray-200 py-2 px-1.5">
                        <div onClick={() => setOpen(false)} className="hoverEffect w-10 h-9 flex items-center justify-center">
                    ...
                    <div className='p-2 flex items-center space-x-1 relative' >
                        ...
                        <span className='text-sm sm:text-[15px] hover:underline'>
                            <Moment date={post?.data()?.timestamp?.toDate()} fromNow />
                        </span>
                    </div>
